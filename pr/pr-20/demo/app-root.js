...
fill=""></path>
  ...
  `;te=d([W("ia-icon-label")],te);let N=class extends C{constructor(){super(...arguments),this.identifier="Flash",this.lists=[]}get checkIcon(){return $`<svg viewBox="0 0 100 100"
