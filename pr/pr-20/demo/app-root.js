 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var G;const V=window,O=V.trustedTypes,de=O?O.createPolicy("lit-html",{createHTML:s=>s}):void 0,ee="$lit$",x=`lit$${(Math.random()+"").slice(9)}$`,we="?"+x,Ee=`<${we}>`,A=document,R=()=>A.createComment(""),D=s=>s===null||typeof s!="object"&&typeof s!="function",$e=Array.isArray,Be=s=>$e(s)||typeof(s==null?void 0:s[Symbol.iterator])=="function",q=`[ 	
\f\r]`,P=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ae=/-->/g,ce=/>/g,k=RegExp(`>|${q}(?:([^\\s"'>=/]+)(${q}*=${q}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),he=/'/g,pe=/"/g,ye=/^(?:script|style|textarea|title)$/i,xe=s=>(e,...t)=>({_$litType$:s,strings:e,values:t}),h=xe(1),$=xe(2),L=Symbol.for("lit-noChange"),p=Symbol.for("lit-nothing"),ue=new WeakMap,S=A.createTreeWalker(A,129,null,!1);function _e(s,e){if(!Array.isArray(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return de!==void 0?de.createHTML(e):e}const Oe=(s,e)=>{const t=s.length-1,o=[];let i,n=e===2?"<svg>":"",r=P;for(let a=0;a<t;a++){const l=s[a];let c,u,v=-1,b=0;for(;b<l.length&&(r.lastIndex=b,u=r.exec(l),u!==null);)b=r.lastIndex,r===P?u[1]==="!--"?r=ae:u[1]!==void 0?r=ce:u[2]!==void 0?(ye.test(u[2])&&(i=RegExp("</"+u[2],"g")),r=k):u[3]!==void 0&&(r=k):r===k?u[0]===">"?(r=i??P,v=-1):u[1]===void 0?v=-2:(v=r.lastIndex-u[2].length,c=u[1],r=u[3]===void 0?k:u[3]==='"'?pe:he):r===pe||r===he?r=k:r===ae||r===ce?r=P:(r=k,i=void 0);const y=r===k&&s[a+1].startsWith("/>")?" ":"";n+=r===P?l+Ee:v>=0?(o.push(c),l.slice(0,v)+ee+l.slice(v)+x+y):l+x+(v===-2?(o.push(void 0),a):y)}return[_e(s,n+(s[t]||"<?>")+(e===2?"</svg>":"")),o]};class H{constructor({strings:e,_$litType$:t},o){let i;this.parts=[];let n=0,r=0;const a=e.length-1,l=this.parts,[c,u]=Oe(e,t);if(this.el=H.createElement(c,o),S.currentNode=this.el.content,t===2){const v=this.el.content,b=v.firstChild;b.remove(),v.append(...b.childNodes)}for(;(i=S.nextNode())!==null&&l.length<a;){if(i.nodeType===1){if(i.hasAttributes()){const v=[];for(const b of i.getAttributeNames())if(b.endsWith(ee)||b.startsWith(x)){const y=u[r++];if(v.push(b),y!==void 0){const Ce=i.getAttribute(y.toLowerCase()+ee).split(x),z=/([.?@])?(.*)/.exec(y);l.push({type:1,index:n,name:z[2],strings:Ce,ctor:z[1]==="."?Te:z[1]==="?"?Re:z[1]==="@"?De:W})}else l.push({type:6,index:n})}for(const b of v)i.removeAttribute(b)}if(ye.test(i.tagName)){const v=i.textContent.split(x),b=v.length-1;if(b>0){i.textContent=O?O.emptyScript:"";for(let y=0;y<b;y++)i.append(v[y],R()),S.nextNode(),l.push({type:2,index:++n});i.append(v[b],R())}}}else if(i.nodeType===8)if(i.data===we)l.push({type:2,index:n});else{let v=-1;for(;(v=i.data.indexOf(x,v+1))!==-1;)l.push({type:7,index:n}),v+=x.length-1}n++}}static createElement(e,t){const o=A.createElement("template");return o.innerHTML=e,o}}function T(s,e,t=s,o){var i,n,r,a;if(e===L)return e;let l=o!==void 0?(i=t._$Co)===null||i===void 0?void 0:i[o]:t._$Cl;const c=D(e)?void 0:e._$litDirective$;return(l==null?void 0:l.constructor)!==c&&((n=l==null?void 0:l._$AO)===null||n===void 0||n.call(l,!1),c===void 0?l=void 0:(l=new c(s),l._$AT(s,t,o)),o!==void 0?((r=(a=t)._$Co)!==null&&r!==void 0?r:a._$Co=[])[o]=l:t._$Cl=l),l!==void 0&&(e=T(s,l._$AS(s,e.values),l,o)),e}class Le{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:o},parts:i}=this._$AD,n=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:A).importNode(o,!0);S.currentNode=n;let r=S.nextNode(),a=0,l=0,c=i[0];for(;c!==void 0;){if(a===c.index){let u;c.type===2?u=new I(r,r.nextSibling,this,e):c.type===1?u=new c.ctor(r,c.name,c.strings,this,e):c.type===6&&(u=new He(r,this,e)),this._$AV.push(u),c=i[++l]}a!==(c==null?void 0:c.index)&&(r=S.nextNode(),a++)}return S.currentNode=A,n}v(e){let t=0;for(const o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(e,o,t),t+=o.strings.length-2):o._$AI(e[t])),t++}}class I{constructor(e,t,o,i){var n;this.type=2,this._$AH=p,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=o,this.options=i,this._$Cp=(n=i==null?void 0:i.isConnected)===null||n===void 0||n}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=T(this,e,t),D(e)?e===p||e==null||e===""?(this._$AH!==p&&this._$AR(),this._$AH=p):e!==this._$AH&&e!==L&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):Be(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==p&&D(this._$AH)?this._$AA.nextSibling.data=e:this.$(A.createTextNode(e)),this._$AH=e}g(e){var t;const{values:o,_$litType$:i}=e,n=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=H.createElement(_e(i.h,i.h[0]),this.options)),i);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===n)this._$AH.v(o);else{const r=new Le(n,this),a=r.u(this.options);r.v(o),this.$(a),this._$AH=r}}_$AC(e){let t=ue.get(e.strings);return t===void 0&&ue.set(e.strings,t=new H(e)),t}T(e){$e(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let o,i=0;for(const n of e)i===t.length?t.push(o=new I(this.k(R()),this.k(R()),this,this.options)):o=t[i],o._$AI(n),i++;i<t.length&&(this._$AR(o&&o._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){var o;for((o=this._$AP)===null||o===void 0||o.call(this,!1,!0,t);e&&e!==this._$AB;){const i=e.nextSibling;e.remove(),e=i}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class W{constructor(e,t,o,i,n){this.type=1,this._$AH=p,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=n,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=p}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,o,i){const n=this.strings;let r=!1;if(n===void 0)e=T(this,e,t,0),r=!D(e)||e!==this._$AH&&e!==L,r&&(this._$AH=e);else{const a=e;let l,c;for(e=n[0],l=0;l<n.length-1;l++)c=T(this,a[o+l],t,l),c===L&&(c=this._$AH[l]),r||(r=!D(c)||c!==this._$AH[l]),c===p?e=p:e!==p&&(e+=(c??"")+n[l+1]),this._$AH[l]=c}r&&!i&&this.j(e)}j(e){e===p?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Te extends W{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===p?void 0:e}}const Pe=O?O.emptyScript:"";class Re extends W{constructor(){super(...arguments),this.type=4}j(e){e&&e!==p?this.element.setAttribute(this.name,Pe):this.element.removeAttribute(this.name)}}class De extends W{constructor(e,t,o,i,n){super(e,t,o,i,n),this.type=5}_$AI(e,t=this){var o;if((e=(o=T(this,e,t,0))!==null&&o!==void 0?o:p)===L)return;const i=this._$AH,n=e===p&&i!==p||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,r=e!==p&&(i===p||n);n&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,o;typeof this._$AH=="function"?this._$AH.call((o=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&o!==void 0?o:this.element,e):this._$AH.handleEvent(e)}}class He{constructor(e,t,o){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(e){T(this,e)}}const ve=V.litHtmlPolyfillSupport;ve==null||ve(H,I),((G=V.litHtmlVersions)!==null&&G!==void 0?G:V.litHtmlVersions=[]).push("2.8.0");const Ie=(s,e,t)=>{var o,i;const n=(o=t==null?void 0:t.renderBefore)!==null&&o!==void 0?o:e;let r=n._$litPart$;if(r===void 0){const a=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:null;n._$litPart$=r=new I(e.insertBefore(R(),a),a,void 0,t??{})}return r._$AI(s),r};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Z,J;class _ extends B{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const o=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=o.firstChild),o}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ie(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return L}}_.finalized=!0,_._$litElement$=!0,(Z=globalThis.litElementHydrateSupport)===null||Z===void 0||Z.call(globalThis,{LitElement:_});const ge=globalThis.litElementPolyfillSupport;ge==null||ge({LitElement:_});((J=globalThis.litElementVersions)!==null&&J!==void 0?J:globalThis.litElementVersions=[]).push("3.3.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function C(s){return f({...s,state:!0})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
fill=""></path>
      ...
      <span
        ...
        tabindex=${fe(e)}
        role=${fe(t)}
        @click=${this.isDisabled?p:this.caretClicked}
        @keydown=${this.isDisabled?p:this.caretKeyDown}
      >
    ...
    `:h``:h``}render(){return h`
      <div class="ia-dropdown-group">
        <button
          class="click-main"
          @click=${this.hasCustomClickHandler||this.isDisabled?p:this.mainButtonClicked}
  ...
  `;te=d([j("ia-icon-label")],te);let N=class extends _{constructor(){super(...arguments),this.identifier="Flash",this.lists=[]}get checkIcon(){return $`<svg viewBox="0 0 100 100"
...
<svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 100 100" fill="#F6C604">
  ...
  `;d([f({type:String,attribute:!0,reflect:!0})],g.prototype,"colorScheme",void 0);d([f({type:Object})],g.prototype,"selectedOption",void 0);d([C()],g.prototype,"displayCaret",void 0);d([C()],g.prototype,"disable",void 0);d([C()],g.prototype,"openViaButton",void 0);d([C()],g.prototype,"openViaCaret",void 0);d([C()],g.prototype,"closeOnSelect",void 0);d([C()],g.prototype,"includeSelectedOption",void 0);d([C()],g.prototype,"selectedCount",void 0);d([C()],g.prototype,"userlistData",void 0);d([E("#display-caret-check")],g.prototype,"displayCaretCheck",void 0);d([E("#disable-check")],g.prototype,"disableCheck",void 0);d([E("#open-via-button")],g.prototype,"openViaButtonCheck",void 0);d([E("#open-via-caret")],g.prototype,"openViaCaretCheck",void 0);d([E("#close-on-select")],g.prototype,"closeOnSelectCheck",void 0);d([E("#include-selected-option")],g.prototype,"includeSelectedOptionCheck",void 0);d([E("#user-list-dropdown")],g.prototype,"userListDropdown",void 0);g=d([j("app-root")],g);
