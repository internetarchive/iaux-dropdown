(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function e(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(i){if(i.ep)return;i.ep=!0;const n=e(i);fetch(i.href,n)}})();function p(s,t,e,o){var i=arguments.length,n=i<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(s,t,e,o);else for(var a=s.length-1;a>=0;a--)(r=s[a])&&(n=(i<3?r(n):i>3?r(t,e,n):r(t,e))||n);return i>3&&n&&Object.defineProperty(t,e,n),n}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const J=window,yt=J.ShadowRoot&&(J.ShadyCSS===void 0||J.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,_t=Symbol(),xt=new WeakMap;let Vt=class{constructor(t,e,o){if(this._$cssResult$=!0,o!==_t)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(yt&&t===void 0){const o=e!==void 0&&e.length===1;o&&(t=xt.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),o&&xt.set(e,t))}return t}toString(){return this.cssText}};const ie=s=>new Vt(typeof s=="string"?s:s+"",void 0,_t),y=(s,...t)=>{const e=s.length===1?s[0]:t.reduce((o,i,n)=>o+(r=>{if(r._$cssResult$===!0)return r.cssText;if(typeof r=="number")return r;throw Error("Value passed to 'css' function must be a 'css' function result: "+r+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+s[n+1],s[0]);return new Vt(e,s,_t)},ne=(s,t)=>{yt?s.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet):t.forEach(e=>{const o=document.createElement("style"),i=J.litNonce;i!==void 0&&o.setAttribute("nonce",i),o.textContent=e.cssText,s.appendChild(o)})},At=yt?s=>s:s=>s instanceof CSSStyleSheet?(t=>{let e="";for(const o of t.cssRules)e+=o.cssText;return ie(e)})(s):s;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var rt;const X=window,Ct=X.trustedTypes,se=Ct?Ct.emptyScript:"",kt=X.reactiveElementPolyfillSupport,$t={toAttribute(s,t){switch(t){case Boolean:s=s?se:null;break;case Object:case Array:s=s==null?s:JSON.stringify(s)}return s},fromAttribute(s,t){let e=s;switch(t){case Boolean:e=s!==null;break;case Number:e=s===null?null:Number(s);break;case Object:case Array:try{e=JSON.parse(s)}catch{e=null}}return e}},Wt=(s,t)=>t!==s&&(t==t||s==s),lt={attribute:!0,type:String,converter:$t,reflect:!1,hasChanged:Wt},gt="finalized";let R=class extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this._$Eu()}static addInitializer(t){var e;this.finalize(),((e=this.h)!==null&&e!==void 0?e:this.h=[]).push(t)}static get observedAttributes(){this.finalize();const t=[];return this.elementProperties.forEach((e,o)=>{const i=this._$Ep(o,e);i!==void 0&&(this._$Ev.set(i,o),t.push(i))}),t}static createProperty(t,e=lt){if(e.state&&(e.attribute=!1),this.finalize(),this.elementProperties.set(t,e),!e.noAccessor&&!this.prototype.hasOwnProperty(t)){const o=typeof t=="symbol"?Symbol():"__"+t,i=this.getPropertyDescriptor(t,o,e);i!==void 0&&Object.defineProperty(this.prototype,t,i)}}static getPropertyDescriptor(t,e,o){return{get(){return this[e]},set(i){const n=this[t];this[e]=i,this.requestUpdate(t,n,o)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)||lt}static finalize(){if(this.hasOwnProperty(gt))return!1;this[gt]=!0;const t=Object.getPrototypeOf(this);if(t.finalize(),t.h!==void 0&&(this.h=[...t.h]),this.elementProperties=new Map(t.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const e=this.properties,o=[...Object.getOwnPropertyNames(e),...Object.getOwnPropertySymbols(e)];for(const i of o)this.createProperty(i,e[i])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const o=new Set(t.flat(1/0).reverse());for(const i of o)e.unshift(At(i))}else t!==void 0&&e.push(At(t));return e}static _$Ep(t,e){const o=e.attribute;return o===!1?void 0:typeof o=="string"?o:typeof t=="string"?t.toLowerCase():void 0}_$Eu(){var t;this._$E_=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(t=this.constructor.h)===null||t===void 0||t.forEach(e=>e(this))}addController(t){var e,o;((e=this._$ES)!==null&&e!==void 0?e:this._$ES=[]).push(t),this.renderRoot!==void 0&&this.isConnected&&((o=t.hostConnected)===null||o===void 0||o.call(t))}removeController(t){var e;(e=this._$ES)===null||e===void 0||e.splice(this._$ES.indexOf(t)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((t,e)=>{this.hasOwnProperty(e)&&(this._$Ei.set(e,this[e]),delete this[e])})}createRenderRoot(){var t;const e=(t=this.shadowRoot)!==null&&t!==void 0?t:this.attachShadow(this.constructor.shadowRootOptions);return ne(e,this.constructor.elementStyles),e}connectedCallback(){var t;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$ES)===null||t===void 0||t.forEach(e=>{var o;return(o=e.hostConnected)===null||o===void 0?void 0:o.call(e)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$ES)===null||t===void 0||t.forEach(e=>{var o;return(o=e.hostDisconnected)===null||o===void 0?void 0:o.call(e)})}attributeChangedCallback(t,e,o){this._$AK(t,o)}_$EO(t,e,o=lt){var i;const n=this.constructor._$Ep(t,o);if(n!==void 0&&o.reflect===!0){const r=(((i=o.converter)===null||i===void 0?void 0:i.toAttribute)!==void 0?o.converter:$t).toAttribute(e,o.type);this._$El=t,r==null?this.removeAttribute(n):this.setAttribute(n,r),this._$El=null}}_$AK(t,e){var o;const i=this.constructor,n=i._$Ev.get(t);if(n!==void 0&&this._$El!==n){const r=i.getPropertyOptions(n),a=typeof r.converter=="function"?{fromAttribute:r.converter}:((o=r.converter)===null||o===void 0?void 0:o.fromAttribute)!==void 0?r.converter:$t;this._$El=n,this[n]=a.fromAttribute(e,r.type),this._$El=null}}requestUpdate(t,e,o){let i=!0;t!==void 0&&(((o=o||this.constructor.getPropertyOptions(t)).hasChanged||Wt)(this[t],e)?(this._$AL.has(t)||this._$AL.set(t,e),o.reflect===!0&&this._$El!==t&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(t,o))):i=!1),!this.isUpdatePending&&i&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(e){Promise.reject(e)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var t;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((i,n)=>this[n]=i),this._$Ei=void 0);let e=!1;const o=this._$AL;try{e=this.shouldUpdate(o),e?(this.willUpdate(o),(t=this._$ES)===null||t===void 0||t.forEach(i=>{var n;return(n=i.hostUpdate)===null||n===void 0?void 0:n.call(i)}),this.update(o)):this._$Ek()}catch(i){throw e=!1,this._$Ek(),i}e&&this._$AE(o)}willUpdate(t){}_$AE(t){var e;(e=this._$ES)===null||e===void 0||e.forEach(o=>{var i;return(i=o.hostUpdated)===null||i===void 0?void 0:i.call(o)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(t){return!0}update(t){this._$EC!==void 0&&(this._$EC.forEach((e,o)=>this._$EO(o,this[o],e)),this._$EC=void 0),this._$Ek()}updated(t){}firstUpdated(t){}};R[gt]=!0,R.elementProperties=new Map,R.elementStyles=[],R.shadowRootOptions={mode:"open"},kt==null||kt({ReactiveElement:R}),((rt=X.reactiveElementVersions)!==null&&rt!==void 0?rt:X.reactiveElementVersions=[]).push("1.6.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var dt;const Q=window,M=Q.trustedTypes,St=M?M.createPolicy("lit-html",{createHTML:s=>s}):void 0,mt="$lit$",C=`lit$${(Math.random()+"").slice(9)}$`,jt="?"+C,re=`<${jt}>`,P=document,Y=()=>P.createComment(""),j=s=>s===null||typeof s!="object"&&typeof s!="function",Kt=Array.isArray,le=s=>Kt(s)||typeof(s==null?void 0:s[Symbol.iterator])=="function",at=`[ 	
\f\r]`,V=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Bt=/-->/g,Et=/>/g,E=RegExp(`>|${at}(?:([^\\s"'>=/]+)(${at}*=${at}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ot=/'/g,Ht=/"/g,Ft=/^(?:script|style|textarea|title)$/i,K=Symbol.for("lit-noChange"),w=Symbol.for("lit-nothing"),Tt=new WeakMap,H=P.createTreeWalker(P,129,null,!1);function Zt(s,t){if(!Array.isArray(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return St!==void 0?St.createHTML(t):t}const de=(s,t)=>{const e=s.length-1,o=[];let i,n=t===2?"<svg>":"",r=V;for(let a=0;a<e;a++){const l=s[a];let d,h,c=-1,u=0;for(;u<l.length&&(r.lastIndex=u,h=r.exec(l),h!==null);)u=r.lastIndex,r===V?h[1]==="!--"?r=Bt:h[1]!==void 0?r=Et:h[2]!==void 0?(Ft.test(h[2])&&(i=RegExp("</"+h[2],"g")),r=E):h[3]!==void 0&&(r=E):r===E?h[0]===">"?(r=i??V,c=-1):h[1]===void 0?c=-2:(c=r.lastIndex-h[2].length,d=h[1],r=h[3]===void 0?E:h[3]==='"'?Ht:Ot):r===Ht||r===Ot?r=E:r===Bt||r===Et?r=V:(r=E,i=void 0);const $=r===E&&s[a+1].startsWith("/>")?" ":"";n+=r===V?l+re:c>=0?(o.push(d),l.slice(0,c)+mt+l.slice(c)+C+$):l+C+(c===-2?(o.push(void 0),a):$)}return[Zt(s,n+(s[e]||"<?>")+(t===2?"</svg>":"")),o]};let ft=class qt{constructor({strings:t,_$litType$:e},o){let i;this.parts=[];let n=0,r=0;const a=t.length-1,l=this.parts,[d,h]=de(t,e);if(this.el=qt.createElement(d,o),H.currentNode=this.el.content,e===2){const c=this.el.content,u=c.firstChild;u.remove(),c.append(...u.childNodes)}for(;(i=H.nextNode())!==null&&l.length<a;){if(i.nodeType===1){if(i.hasAttributes()){const c=[];for(const u of i.getAttributeNames())if(u.endsWith(mt)||u.startsWith(C)){const $=h[r++];if(c.push(u),$!==void 0){const st=i.getAttribute($.toLowerCase()+mt).split(C),A=/([.?@])?(.*)/.exec($);l.push({type:1,index:n,name:A[2],strings:st,ctor:A[1]==="."?ce:A[1]==="?"?pe:A[1]==="@"?ue:ot})}else l.push({type:6,index:n})}for(const u of c)i.removeAttribute(u)}if(Ft.test(i.tagName)){const c=i.textContent.split(C),u=c.length-1;if(u>0){i.textContent=M?M.emptyScript:"";for(let $=0;$<u;$++)i.append(c[$],Y()),H.nextNode(),l.push({type:2,index:++n});i.append(c[u],Y())}}}else if(i.nodeType===8)if(i.data===jt)l.push({type:2,index:n});else{let c=-1;for(;(c=i.data.indexOf(C,c+1))!==-1;)l.push({type:7,index:n}),c+=C.length-1}n++}}static createElement(t,e){const o=P.createElement("template");return o.innerHTML=t,o}};function I(s,t,e=s,o){var i,n,r,a;if(t===K)return t;let l=o!==void 0?(i=e._$Co)===null||i===void 0?void 0:i[o]:e._$Cl;const d=j(t)?void 0:t._$litDirective$;return(l==null?void 0:l.constructor)!==d&&((n=l==null?void 0:l._$AO)===null||n===void 0||n.call(l,!1),d===void 0?l=void 0:(l=new d(s),l._$AT(s,e,o)),o!==void 0?((r=(a=e)._$Co)!==null&&r!==void 0?r:a._$Co=[])[o]=l:e._$Cl=l),l!==void 0&&(t=I(s,l._$AS(s,t.values),l,o)),t}let ae=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var e;const{el:{content:o},parts:i}=this._$AD,n=((e=t==null?void 0:t.creationScope)!==null&&e!==void 0?e:P).importNode(o,!0);H.currentNode=n;let r=H.nextNode(),a=0,l=0,d=i[0];for(;d!==void 0;){if(a===d.index){let h;d.type===2?h=new Gt(r,r.nextSibling,this,t):d.type===1?h=new d.ctor(r,d.name,d.strings,this,t):d.type===6&&(h=new ve(r,this,t)),this._$AV.push(h),d=i[++l]}a!==(d==null?void 0:d.index)&&(r=H.nextNode(),a++)}return H.currentNode=P,n}v(t){let e=0;for(const o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(t,o,e),e+=o.strings.length-2):o._$AI(t[e])),e++}},Gt=class Jt{constructor(t,e,o,i){var n;this.type=2,this._$AH=w,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=o,this.options=i,this._$Cp=(n=i==null?void 0:i.isConnected)===null||n===void 0||n}get _$AU(){var t,e;return(e=(t=this._$AM)===null||t===void 0?void 0:t._$AU)!==null&&e!==void 0?e:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=I(this,t,e),j(t)?t===w||t==null||t===""?(this._$AH!==w&&this._$AR(),this._$AH=w):t!==this._$AH&&t!==K&&this._(t):t._$litType$!==void 0?this.g(t):t.nodeType!==void 0?this.$(t):le(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==w&&j(this._$AH)?this._$AA.nextSibling.data=t:this.$(P.createTextNode(t)),this._$AH=t}g(t){var e;const{values:o,_$litType$:i}=t,n=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=ft.createElement(Zt(i.h,i.h[0]),this.options)),i);if(((e=this._$AH)===null||e===void 0?void 0:e._$AD)===n)this._$AH.v(o);else{const r=new ae(n,this),a=r.u(this.options);r.v(o),this.$(a),this._$AH=r}}_$AC(t){let e=Tt.get(t.strings);return e===void 0&&Tt.set(t.strings,e=new ft(t)),e}T(t){Kt(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let o,i=0;for(const n of t)i===e.length?e.push(o=new Jt(this.k(Y()),this.k(Y()),this,this.options)):o=e[i],o._$AI(n),i++;i<e.length&&(this._$AR(o&&o._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){var o;for((o=this._$AP)===null||o===void 0||o.call(this,!1,!0,e);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i}}setConnected(t){var e;this._$AM===void 0&&(this._$Cp=t,(e=this._$AP)===null||e===void 0||e.call(this,t))}},ot=class{constructor(t,e,o,i,n){this.type=1,this._$AH=w,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=n,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=w}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,o,i){const n=this.strings;let r=!1;if(n===void 0)t=I(this,t,e,0),r=!j(t)||t!==this._$AH&&t!==K,r&&(this._$AH=t);else{const a=t;let l,d;for(t=n[0],l=0;l<n.length-1;l++)d=I(this,a[o+l],e,l),d===K&&(d=this._$AH[l]),r||(r=!j(d)||d!==this._$AH[l]),d===w?t=w:t!==w&&(t+=(d??"")+n[l+1]),this._$AH[l]=d}r&&!i&&this.j(t)}j(t){t===w?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},ce=class extends ot{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===w?void 0:t}};const he=M?M.emptyScript:"";let pe=class extends ot{constructor(){super(...arguments),this.type=4}j(t){t&&t!==w?this.element.setAttribute(this.name,he):this.element.removeAttribute(this.name)}},ue=class extends ot{constructor(t,e,o,i,n){super(t,e,o,i,n),this.type=5}_$AI(t,e=this){var o;if((t=(o=I(this,t,e,0))!==null&&o!==void 0?o:w)===K)return;const i=this._$AH,n=t===w&&i!==w||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,r=t!==w&&(i===w||n);n&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,o;typeof this._$AH=="function"?this._$AH.call((o=(e=this.options)===null||e===void 0?void 0:e.host)!==null&&o!==void 0?o:this.element,t):this._$AH.handleEvent(t)}},ve=class{constructor(t,e,o){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(t){I(this,t)}};const Pt=Q.litHtmlPolyfillSupport;Pt==null||Pt(ft,Gt),((dt=Q.litHtmlVersions)!==null&&dt!==void 0?dt:Q.litHtmlVersions=[]).push("2.8.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ct;const tt=window,N=tt.trustedTypes,Lt=N?N.createPolicy("lit-html",{createHTML:s=>s}):void 0,bt="$lit$",k=`lit$${(Math.random()+"").slice(9)}$`,Xt="?"+k,$e=`<${Xt}>`,L=document,F=()=>L.createComment(""),Z=s=>s===null||typeof s!="object"&&typeof s!="function",Qt=Array.isArray,ge=s=>Qt(s)||typeof(s==null?void 0:s[Symbol.iterator])=="function",ht=`[ 	
\f\r]`,W=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Dt=/-->/g,Rt=/>/g,O=RegExp(`>|${ht}(?:([^\\s"'>=/]+)(${ht}*=${ht}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Mt=/'/g,It=/"/g,Yt=/^(?:script|style|textarea|title)$/i,te=s=>(t,...e)=>({_$litType$:s,strings:t,values:e}),v=te(1),_=te(2),U=Symbol.for("lit-noChange"),m=Symbol.for("lit-nothing"),Nt=new WeakMap,T=L.createTreeWalker(L,129,null,!1);function ee(s,t){if(!Array.isArray(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return Lt!==void 0?Lt.createHTML(t):t}const me=(s,t)=>{const e=s.length-1,o=[];let i,n=t===2?"<svg>":"",r=W;for(let a=0;a<e;a++){const l=s[a];let d,h,c=-1,u=0;for(;u<l.length&&(r.lastIndex=u,h=r.exec(l),h!==null);)u=r.lastIndex,r===W?h[1]==="!--"?r=Dt:h[1]!==void 0?r=Rt:h[2]!==void 0?(Yt.test(h[2])&&(i=RegExp("</"+h[2],"g")),r=O):h[3]!==void 0&&(r=O):r===O?h[0]===">"?(r=i??W,c=-1):h[1]===void 0?c=-2:(c=r.lastIndex-h[2].length,d=h[1],r=h[3]===void 0?O:h[3]==='"'?It:Mt):r===It||r===Mt?r=O:r===Dt||r===Rt?r=W:(r=O,i=void 0);const $=r===O&&s[a+1].startsWith("/>")?" ":"";n+=r===W?l+$e:c>=0?(o.push(d),l.slice(0,c)+bt+l.slice(c)+k+$):l+k+(c===-2?(o.push(void 0),a):$)}return[ee(s,n+(s[e]||"<?>")+(t===2?"</svg>":"")),o]};class q{constructor({strings:t,_$litType$:e},o){let i;this.parts=[];let n=0,r=0;const a=t.length-1,l=this.parts,[d,h]=me(t,e);if(this.el=q.createElement(d,o),T.currentNode=this.el.content,e===2){const c=this.el.content,u=c.firstChild;u.remove(),c.append(...u.childNodes)}for(;(i=T.nextNode())!==null&&l.length<a;){if(i.nodeType===1){if(i.hasAttributes()){const c=[];for(const u of i.getAttributeNames())if(u.endsWith(bt)||u.startsWith(k)){const $=h[r++];if(c.push(u),$!==void 0){const st=i.getAttribute($.toLowerCase()+bt).split(k),A=/([.?@])?(.*)/.exec($);l.push({type:1,index:n,name:A[2],strings:st,ctor:A[1]==="."?be:A[1]==="?"?ye:A[1]==="@"?_e:it})}else l.push({type:6,index:n})}for(const u of c)i.removeAttribute(u)}if(Yt.test(i.tagName)){const c=i.textContent.split(k),u=c.length-1;if(u>0){i.textContent=N?N.emptyScript:"";for(let $=0;$<u;$++)i.append(c[$],F()),T.nextNode(),l.push({type:2,index:++n});i.append(c[u],F())}}}else if(i.nodeType===8)if(i.data===Xt)l.push({type:2,index:n});else{let c=-1;for(;(c=i.data.indexOf(k,c+1))!==-1;)l.push({type:7,index:n}),c+=k.length-1}n++}}static createElement(t,e){const o=L.createElement("template");return o.innerHTML=t,o}}function z(s,t,e=s,o){var i,n,r,a;if(t===U)return t;let l=o!==void 0?(i=e._$Co)===null||i===void 0?void 0:i[o]:e._$Cl;const d=Z(t)?void 0:t._$litDirective$;return(l==null?void 0:l.constructor)!==d&&((n=l==null?void 0:l._$AO)===null||n===void 0||n.call(l,!1),d===void 0?l=void 0:(l=new d(s),l._$AT(s,e,o)),o!==void 0?((r=(a=e)._$Co)!==null&&r!==void 0?r:a._$Co=[])[o]=l:e._$Cl=l),l!==void 0&&(t=z(s,l._$AS(s,t.values),l,o)),t}class fe{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var e;const{el:{content:o},parts:i}=this._$AD,n=((e=t==null?void 0:t.creationScope)!==null&&e!==void 0?e:L).importNode(o,!0);T.currentNode=n;let r=T.nextNode(),a=0,l=0,d=i[0];for(;d!==void 0;){if(a===d.index){let h;d.type===2?h=new G(r,r.nextSibling,this,t):d.type===1?h=new d.ctor(r,d.name,d.strings,this,t):d.type===6&&(h=new xe(r,this,t)),this._$AV.push(h),d=i[++l]}a!==(d==null?void 0:d.index)&&(r=T.nextNode(),a++)}return T.currentNode=L,n}v(t){let e=0;for(const o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(t,o,e),e+=o.strings.length-2):o._$AI(t[e])),e++}}class G{constructor(t,e,o,i){var n;this.type=2,this._$AH=m,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=o,this.options=i,this._$Cp=(n=i==null?void 0:i.isConnected)===null||n===void 0||n}get _$AU(){var t,e;return(e=(t=this._$AM)===null||t===void 0?void 0:t._$AU)!==null&&e!==void 0?e:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=z(this,t,e),Z(t)?t===m||t==null||t===""?(this._$AH!==m&&this._$AR(),this._$AH=m):t!==this._$AH&&t!==U&&this._(t):t._$litType$!==void 0?this.g(t):t.nodeType!==void 0?this.$(t):ge(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==m&&Z(this._$AH)?this._$AA.nextSibling.data=t:this.$(L.createTextNode(t)),this._$AH=t}g(t){var e;const{values:o,_$litType$:i}=t,n=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=q.createElement(ee(i.h,i.h[0]),this.options)),i);if(((e=this._$AH)===null||e===void 0?void 0:e._$AD)===n)this._$AH.v(o);else{const r=new fe(n,this),a=r.u(this.options);r.v(o),this.$(a),this._$AH=r}}_$AC(t){let e=Nt.get(t.strings);return e===void 0&&Nt.set(t.strings,e=new q(t)),e}T(t){Qt(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let o,i=0;for(const n of t)i===e.length?e.push(o=new G(this.k(F()),this.k(F()),this,this.options)):o=e[i],o._$AI(n),i++;i<e.length&&(this._$AR(o&&o._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){var o;for((o=this._$AP)===null||o===void 0||o.call(this,!1,!0,e);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i}}setConnected(t){var e;this._$AM===void 0&&(this._$Cp=t,(e=this._$AP)===null||e===void 0||e.call(this,t))}}class it{constructor(t,e,o,i,n){this.type=1,this._$AH=m,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=n,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=m}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,o,i){const n=this.strings;let r=!1;if(n===void 0)t=z(this,t,e,0),r=!Z(t)||t!==this._$AH&&t!==U,r&&(this._$AH=t);else{const a=t;let l,d;for(t=n[0],l=0;l<n.length-1;l++)d=z(this,a[o+l],e,l),d===U&&(d=this._$AH[l]),r||(r=!Z(d)||d!==this._$AH[l]),d===m?t=m:t!==m&&(t+=(d??"")+n[l+1]),this._$AH[l]=d}r&&!i&&this.j(t)}j(t){t===m?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class be extends it{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===m?void 0:t}}const we=N?N.emptyScript:"";class ye extends it{constructor(){super(...arguments),this.type=4}j(t){t&&t!==m?this.element.setAttribute(this.name,we):this.element.removeAttribute(this.name)}}class _e extends it{constructor(t,e,o,i,n){super(t,e,o,i,n),this.type=5}_$AI(t,e=this){var o;if((t=(o=z(this,t,e,0))!==null&&o!==void 0?o:m)===U)return;const i=this._$AH,n=t===m&&i!==m||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,r=t!==m&&(i===m||n);n&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,o;typeof this._$AH=="function"?this._$AH.call((o=(e=this.options)===null||e===void 0?void 0:e.host)!==null&&o!==void 0?o:this.element,t):this._$AH.handleEvent(t)}}class xe{constructor(t,e,o){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(t){z(this,t)}}const Ut=tt.litHtmlPolyfillSupport;Ut==null||Ut(q,G),((ct=tt.litHtmlVersions)!==null&&ct!==void 0?ct:tt.litHtmlVersions=[]).push("2.8.0");const Ae=(s,t,e)=>{var o,i;const n=(o=e==null?void 0:e.renderBefore)!==null&&o!==void 0?o:t;let r=n._$litPart$;if(r===void 0){const a=(i=e==null?void 0:e.renderBefore)!==null&&i!==void 0?i:null;n._$litPart$=r=new G(t.insertBefore(F(),a),a,void 0,e??{})}return r._$AI(s),r};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const nt=s=>t=>typeof t=="function"?((e,o)=>(customElements.define(e,o),o))(s,t):((e,o)=>{const{kind:i,elements:n}=o;return{kind:i,elements:n,finisher(r){customElements.define(e,r)}}})(s,t);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ce=(s,t)=>t.kind==="method"&&t.descriptor&&!("value"in t.descriptor)?{...t,finisher(e){e.createProperty(t.key,s)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:t.key,initializer(){typeof t.initializer=="function"&&(this[t.key]=t.initializer.call(this))},finisher(e){e.createProperty(t.key,s)}},ke=(s,t,e)=>{t.constructor.createProperty(e,s)};function b(s){return(t,e)=>e!==void 0?ke(s,t,e):Ce(s,t)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function B(s){return b({...s,state:!0})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const oe=({finisher:s,descriptor:t})=>(e,o)=>{var i;if(o===void 0){const n=(i=e.originalKey)!==null&&i!==void 0?i:e.key,r=t!=null?{kind:"method",placement:"prototype",key:n,descriptor:t(e.key)}:{...e,key:n};return s!=null&&(r.finisher=function(a){s(a,n)}),r}{const n=e.constructor;t!==void 0&&Object.defineProperty(e,o,t(o)),s==null||s(n,o)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function x(s,t){return oe({descriptor:e=>{const o={get(){var i,n;return(n=(i=this.renderRoot)===null||i===void 0?void 0:i.querySelector(s))!==null&&n!==void 0?n:null},enumerable:!0,configurable:!0};if(t){const i=typeof e=="symbol"?Symbol():"__"+e;o.get=function(){var n,r;return this[i]===void 0&&(this[i]=(r=(n=this.renderRoot)===null||n===void 0?void 0:n.querySelector(s))!==null&&r!==void 0?r:null),this[i]}}return o}})}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var vt;const Se=((vt=window.HTMLSlotElement)===null||vt===void 0?void 0:vt.prototype.assignedElements)!=null?(s,t)=>s.assignedElements(t):(s,t)=>s.assignedNodes(t).filter(e=>e.nodeType===Node.ELEMENT_NODE);function Be(s){const{slot:t,selector:e}=s??{};return oe({descriptor:o=>({get(){var i;const n="slot"+(t?`[name=${t}]`:":not([name])"),r=(i=this.renderRoot)===null||i===void 0?void 0:i.querySelector(n),a=r!=null?Se(r,s):[];return e?a.filter(l=>l.matches(e)):a},enumerable:!0,configurable:!0})})}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function D(s,t,e){return s?t():e==null?void 0:e()}const Ee=_`<svg class="caret-up-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
...
fill=""></path>
    ...
    `}static get styles(){const t=y`var(--dropdownBorderWidth, 1px)`,e=y`var(--dropdownBorderRadius, 4px)`,o=y`var(--dropdownBorderColor, #fff)`,i=y`var(--dropdownBgColor, #333)`,n=y`var(--dropdownTextColor, #fff)`,r=y`var(--dropdownHoverBgColor, rgba(255, 255, 255, 0.3))`,a=y`var(--dropdownSelectedBgColor, #fff)`,l=y`var(--dropdownMainButtonBgColor, transparent)`,d=y`var(--dropdownTextAlign, inherit)`,h=y`var(--dropdownBackdropZIndex, 1)`,c=y`var(--dropdownListZIndex, 2)`;return y`
      :host {
        display: inline;
        color: ${n};
      }
  ...
  `;wt=p([nt("ia-icon-label")],wt);let et=class extends S{constructor(){super(...arguments),this.identifier="Flash",this.lists=[]}get checkIcon(){return _`<svg viewBox="0 0 100 100"
  ...
  </svg>`}renderUserlistOption(t){const{label:e,isSelected:o,id:i}=t,n=o?"selected":"",r=v`<button
      id="${i}"
      @click=${a=>this.optionClicked(a,t)}
    >
      ${e}
    </button> `;return v`<li class=${n}>${r}</li>`}optionClicked(t,e){var o;t.stopPropagation(),this.dispatchEvent(new CustomEvent("optionSelected",{detail:{option:e}})),(o=e.selectedHandler)===null||o===void 0||o.call(e,e)}checkedIcon(t){return t?v`${this.checkIcon}`:v`<div style="width: 12px; height: 12px;"></div>`}get userListOptions(){const t=[];this.lists.forEach(o=>{const i={label:v` <ia-icon-label>
          <div slot="icon">${this.checkedIcon(o.item_is_member)}</div>
          <div class="truncate">${o.name}</div>
        </ia-icon-label>`,id:o.id,selectedHandler:n=>this.onSelected(n)};t.push(i)});const e={label:v`<ia-icon-label>
