 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var G;const N=window,B=N.trustedTypes,dt=B?B.createPolicy("lit-html",{createHTML:n=>n}):void 0,tt="$lit$",_=`lit$${(Math.random()+"").slice(9)}$`,wt="?"+_,kt=`<${wt}>`,A=document,L=()=>A.createComment(""),H=n=>n===null||typeof n!="object"&&typeof n!="function",$t=Array.isArray,Et=n=>$t(n)||typeof(n==null?void 0:n[Symbol.iterator])=="function",q=`[ 	
\f\r]`,R=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,at=/-->/g,ct=/>/g,C=RegExp(`>|${q}(?:([^\\s"'>=/]+)(${q}*=${q}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ht=/'/g,pt=/"/g,bt=/^(?:script|style|textarea|title)$/i,yt=n=>(t,...e)=>({_$litType$:n,strings:t,values:e}),h=yt(1),b=yt(2),O=Symbol.for("lit-noChange"),p=Symbol.for("lit-nothing"),ut=new WeakMap,S=A.createTreeWalker(A,129,null,!1);function _t(n,t){if(!Array.isArray(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return dt!==void 0?dt.createHTML(t):t}const Bt=(n,t)=>{const e=n.length-1,o=[];let i,r=t===2?"<svg>":"",s=R;for(let d=0;d<e;d++){const l=n[d];let c,u,v=-1,f=0;for(;f<l.length&&(s.lastIndex=f,u=s.exec(l),u!==null);)f=s.lastIndex,s===R?u[1]==="!--"?s=at:u[1]!==void 0?s=ct:u[2]!==void 0?(bt.test(u[2])&&(i=RegExp("</"+u[2],"g")),s=C):u[3]!==void 0&&(s=C):s===C?u[0]===">"?(s=i??R,v=-1):u[1]===void 0?v=-2:(v=s.lastIndex-u[2].length,c=u[1],s=u[3]===void 0?C:u[3]==='"'?pt:ht):s===pt||s===ht?s=C:s===at||s===ct?s=R:(s=C,i=void 0);const y=s===C&&n[d+1].startsWith("/>")?" ":"";r+=s===R?l+kt:v>=0?(o.push(c),l.slice(0,v)+tt+l.slice(v)+_+y):l+_+(v===-2?(o.push(void 0),d):y)}return[_t(n,r+(n[e]||"<?>")+(t===2?"</svg>":"")),o]};class I{constructor({strings:t,_$litType$:e},o){let i;this.parts=[];let r=0,s=0;const d=t.length-1,l=this.parts,[c,u]=Bt(t,e);if(this.el=I.createElement(c,o),S.currentNode=this.el.content,e===2){const v=this.el.content,f=v.firstChild;f.remove(),v.append(...f.childNodes)}for(;(i=S.nextNode())!==null&&l.length<d;){if(i.nodeType===1){if(i.hasAttributes()){const v=[];for(const f of i.getAttributeNames())if(f.endsWith(tt)||f.startsWith(_)){const y=u[s++];if(v.push(f),y!==void 0){const xt=i.getAttribute(y.toLowerCase()+tt).split(_),z=/([.?@])?(.*)/.exec(y);l.push({type:1,index:r,name:z[2],strings:xt,ctor:z[1]==="."?Pt:z[1]==="?"?Rt:z[1]==="@"?Lt:W})}else l.push({type:6,index:r})}for(const f of v)i.removeAttribute(f)}if(bt.test(i.tagName)){const v=i.textContent.split(_),f=v.length-1;if(f>0){i.textContent=B?B.emptyScript:"";for(let y=0;y<f;y++)i.append(v[y],L()),S.nextNode(),l.push({type:2,index:++r});i.append(v[f],L())}}}else if(i.nodeType===8)if(i.data===wt)l.push({type:2,index:r});else{let v=-1;for(;(v=i.data.indexOf(_,v+1))!==-1;)l.push({type:7,index:r}),v+=_.length-1}r++}}static createElement(t,e){const o=A.createElement("template");return o.innerHTML=t,o}}function P(n,t,e=n,o){var i,r,s,d;if(t===O)return t;let l=o!==void 0?(i=e._$Co)===null||i===void 0?void 0:i[o]:e._$Cl;const c=H(t)?void 0:t._$litDirective$;return(l==null?void 0:l.constructor)!==c&&((r=l==null?void 0:l._$AO)===null||r===void 0||r.call(l,!1),c===void 0?l=void 0:(l=new c(n),l._$AT(n,e,o)),o!==void 0?((s=(d=e)._$Co)!==null&&s!==void 0?s:d._$Co=[])[o]=l:e._$Cl=l),l!==void 0&&(t=P(n,l._$AS(n,t.values),l,o)),t}class Ot{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var e;const{el:{content:o},parts:i}=this._$AD,r=((e=t==null?void 0:t.creationScope)!==null&&e!==void 0?e:A).importNode(o,!0);S.currentNode=r;let s=S.nextNode(),d=0,l=0,c=i[0];for(;c!==void 0;){if(d===c.index){let u;c.type===2?u=new U(s,s.nextSibling,this,t):c.type===1?u=new c.ctor(s,c.name,c.strings,this,t):c.type===6&&(u=new Ht(s,this,t)),this._$AV.push(u),c=i[++l]}d!==(c==null?void 0:c.index)&&(s=S.nextNode(),d++)}return S.currentNode=A,r}v(t){let e=0;for(const o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(t,o,e),e+=o.strings.length-2):o._$AI(t[e])),e++}}class U{constructor(t,e,o,i){var r;this.type=2,this._$AH=p,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=o,this.options=i,this._$Cp=(r=i==null?void 0:i.isConnected)===null||r===void 0||r}get _$AU(){var t,e;return(e=(t=this._$AM)===null||t===void 0?void 0:t._$AU)!==null&&e!==void 0?e:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=P(this,t,e),H(t)?t===p||t==null||t===""?(this._$AH!==p&&this._$AR(),this._$AH=p):t!==this._$AH&&t!==O&&this._(t):t._$litType$!==void 0?this.g(t):t.nodeType!==void 0?this.$(t):Et(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==p&&H(this._$AH)?this._$AA.nextSibling.data=t:this.$(A.createTextNode(t)),this._$AH=t}g(t){var e;const{values:o,_$litType$:i}=t,r=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=I.createElement(_t(i.h,i.h[0]),this.options)),i);if(((e=this._$AH)===null||e===void 0?void 0:e._$AD)===r)this._$AH.v(o);else{const s=new Ot(r,this),d=s.u(this.options);s.v(o),this.$(d),this._$AH=s}}_$AC(t){let e=ut.get(t.strings);return e===void 0&&ut.set(t.strings,e=new I(t)),e}T(t){$t(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let o,i=0;for(const r of t)i===e.length?e.push(o=new U(this.k(L()),this.k(L()),this,this.options)):o=e[i],o._$AI(r),i++;i<e.length&&(this._$AR(o&&o._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){var o;for((o=this._$AP)===null||o===void 0||o.call(this,!1,!0,e);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i}}setConnected(t){var e;this._$AM===void 0&&(this._$Cp=t,(e=this._$AP)===null||e===void 0||e.call(this,t))}}class W{constructor(t,e,o,i,r){this.type=1,this._$AH=p,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=r,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=p}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,o,i){const r=this.strings;let s=!1;if(r===void 0)t=P(this,t,e,0),s=!H(t)||t!==this._$AH&&t!==O,s&&(this._$AH=t);else{const d=t;let l,c;for(t=r[0],l=0;l<r.length-1;l++)c=P(this,d[o+l],e,l),c===O&&(c=this._$AH[l]),s||(s=!H(c)||c!==this._$AH[l]),c===p?t=p:t!==p&&(t+=(c??"")+r[l+1]),this._$AH[l]=c}s&&!i&&this.j(t)}j(t){t===p?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Pt extends W{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===p?void 0:t}}const Tt=B?B.emptyScript:"";class Rt extends W{constructor(){super(...arguments),this.type=4}j(t){t&&t!==p?this.element.setAttribute(this.name,Tt):this.element.removeAttribute(this.name)}}class Lt extends W{constructor(t,e,o,i,r){super(t,e,o,i,r),this.type=5}_$AI(t,e=this){var o;if((t=(o=P(this,t,e,0))!==null&&o!==void 0?o:p)===O)return;const i=this._$AH,r=t===p&&i!==p||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,s=t!==p&&(i===p||r);r&&this.element.removeEventListener(this.name,this,i),s&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,o;typeof this._$AH=="function"?this._$AH.call((o=(e=this.options)===null||e===void 0?void 0:e.host)!==null&&o!==void 0?o:this.element,t):this._$AH.handleEvent(t)}}class Ht{constructor(t,e,o){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(t){P(this,t)}}const vt=N.litHtmlPolyfillSupport;vt==null||vt(I,U),((G=N.litHtmlVersions)!==null&&G!==void 0?G:N.litHtmlVersions=[]).push("2.8.0");const It=(n,t,e)=>{var o,i;const r=(o=e==null?void 0:e.renderBefore)!==null&&o!==void 0?o:t;let s=r._$litPart$;if(s===void 0){const d=(i=e==null?void 0:e.renderBefore)!==null&&i!==void 0?i:null;r._$litPart$=s=new U(t.insertBefore(L(),d),d,void 0,e??{})}return s._$AI(n),s};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Z,J;class x extends E{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,e;const o=super.createRenderRoot();return(t=(e=this.renderOptions).renderBefore)!==null&&t!==void 0||(e.renderBefore=o.firstChild),o}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=It(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!1)}render(){return O}}x.finalized=!0,x._$litElement$=!0,(Z=globalThis.litElementHydrateSupport)===null||Z===void 0||Z.call(globalThis,{LitElement:x});const gt=globalThis.litElementPolyfillSupport;gt==null||gt({LitElement:x});((J=globalThis.litElementVersions)!==null&&J!==void 0?J:globalThis.litElementVersions=[]).push("3.3.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function k(n){return m({...n,state:!0})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */var X;((X=window.HTMLSlotElement)===null||X===void 0?void 0:X.prototype.assignedElements)!=null;let w=class extends x{constructor(){super(...arguments),this.open=!1,this.displayCaret=!1,this.closeOnSelect=!1,this.openViaButton=!0,this.openViaCaret=!0,this.includeSelectedOption=!1,this.selectedOption="",this.options=[],this.optionGroup="options",this.optionSelected=()=>{},this.isCustomList=!1,this.handlingCaretClick=!1}async firstUpdated(){await new Promise(t=>setTimeout(t,0)),this.addEventListener("closeDropdown",()=>{this.open=!1})}renderOption(t){const{label:e,url:o=void 0,id:i}=t;let r;const s=this.selectedOption===i?"selected":"";return o?r=h`<a
        href=${o}
    ...
    `}static get styles(){const t=$`var(--dropdownBorderWidth, 1px)`,e=$`var(--dropdownBorderRadius, 4px)`,o=$`var(--dropdownBorderColor, #fff)`,i=$`var(--dropdownBgColor, #333)`,r=$`var(--dropdownTextColor, #fff)`,s=$`var(--dropdownHoverBgColor, rgba(255, 255, 255, 0.3))`,d=$`var(--dropdownSelectedBgColor, #fff)`;return $`
      :host {
        display: inline;
        color: ${r};
      }
  ...
  `;et=a([j("ia-icon-label")],et);let M=class extends x{constructor(){super(...arguments),this.identifier="Flash",this.lists=[]}async firstUpdated(){await new Promise(t=>setTimeout(t,0)),document.addEventListener("keydown",t=>{this.onKeydown(t)})}get checkIcon(){return b`<svg viewBox="0 0 100 100"
    xmlns="http://www.w3.org/2000/svg"
